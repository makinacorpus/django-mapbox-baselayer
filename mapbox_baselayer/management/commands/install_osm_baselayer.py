...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        BaseLayerTile.objects.bulk_create([
            BaseLayerTile(base_layer=base_layer, url="https://a.tile.openstreetmap.org/{z}/{x}/{y}.png"),
            BaseLayerTile(base_layer=base_layer, url="https://b.tile.openstreetmap.org/{z}/{x}/{y}.png"),
            BaseLayerTile(base_layer=base_layer, url="https://c.tile.openstreetmap.org/{z}/{x}/{y}.png"),
        ])
